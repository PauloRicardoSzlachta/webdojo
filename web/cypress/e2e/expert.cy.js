...
describe('Expert', () => {
    ...
    it('Deve manipular os atributos de elementos do HTML', () => {
        ...
        cy.get('#email').invoke('val', 'kadu@teste.com.br')
    ...
    it('Não deve logar com senha inválida', () => {
        ...
        cy.get('#email').type('kadu@webdojo.com')
        cy.get('#password').type('katana1234{Enter}')
    ...
    it('Deve realizar uma carda de dados fakes', () => {
        _.times(5, () => {
